...
const accountFormSchema = z.object({
  name: z
    .string()
    .min(2, {
      message: "Los datos deben tener al menos 2 caracteres.",
    })
    .max(30, {
  ...
  language: z.string({
    required_error: "Seleccione un idioma.",
  }),
});
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Este es el nombre que se mostrará en su perfil y en los
              ...
              <Popover>
                ...
                <PopoverContent className="w-[200px] p-0">
                  <Command>
                    ...
                    <CommandEmpty>No se ha encontrado ningún idioma.</CommandEmpty>
                    <CommandGroup>
